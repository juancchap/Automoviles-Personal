...
public class ModifIAuto extends javax.swing.JFrame {
    ...
    mostrarMensaje("Edicion realizada correctamente","Info","Edicion realozada correctamente");
    
    ConsultaAtomovil consul = new ConsultaAtomovil();
